!(function () {
  ...
  var Rf,
    ...
    ul = function (t, e, r, n) {
      if (!e.done) {
        (e.done = !0), n && (e = n);
        try {
          if (t === r) throw zf("Promise can't be resolved itthis");
          var o = Zf(r);
          o
            ? Tf(function () {
                var n = { done: !1 };
  ...
  Lt(
    ...
    re("Promise", "finally");
  var pl = "URLSearchParams" in this,
    dl = "Symbol" in this && "iterator" in Symbol,
    vl =
      "FileReader" in this &&
      "Blob" in this &&
      (function () {
